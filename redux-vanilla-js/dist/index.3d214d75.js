...
var _counterSlice = require("./slices/CounterSlice");
...
const render = ()=>{
    countEl.textContent = (0, _storeDefault.default).getState().counter.value;
};
incrementBtn.addEventListener("click", ()=>{
    (0, _storeDefault.default).dispatch((0, _counterSlice.increment)());
});
decrementBtn.addEventListener("click", ()=>{
    (0, _storeDefault.default).dispatch((0, _counterSlice.decrement)());
});
resetBtn.addEventListener("click", ()=>{
    (0, _storeDefault.default).dispatch((0, _counterSlice.reset)());
});
(0, _storeDefault.default).subscribe(render);

},{"./store":"9cnTH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./slices/CounterSlice":"hI75s"}],"9cnTH":[function(require,module,exports) {
var _toolkit = require("@reduxjs/toolkit");
var _counterSlice = require("./slices/CounterSlice");
const store = (0, _toolkit.configureStore)({
    reducer: {
        counter: (0, _counterSlice.reducer)
    }
});
module.exports = store;

},{"@reduxjs/toolkit":"lL1Ef","./slices/CounterSlice":"hI75s"}],"lL1Ef":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"728135d01089d859":"d5jf4","immer":"4sfoz","redux":"cDNB3","reselect":"isIsC","redux-thunk":"iFVTZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hI75s":[function(require,module,exports) {
var _toolkit = require("@reduxjs/toolkit");
...
},{"@reduxjs/toolkit":"lL1Ef"}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequirec277")
